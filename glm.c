...
glmReadMTL(GLMmodel* model, char* name)
{
    ...
    model->materials[0].name = (char*)malloc(sizeof("default"));
    ...
    while(fscanf(file, "%s", buf) != EOF) {
        ...
        case 'n':               /* newmtl */
            ...
            sscanf(buf, "%s %s", buf, buf);
            nummaterials++;
            model->materials[nummaterials].name = (char*)malloc(strlen(buf)+1);
    ...
    while(fscanf(file, "%s", buf) != EOF) {
        ...
        case 'v':               /* v, vn, vt */
            ...
            case 'm':
                ...
                model->mtllibname=(char*)malloc(strlen(buf)+1);
...
glmReadOBJ(char* filename)
{
    ...
    model->pathname    = (char*)malloc(strlen(filename)+1);
